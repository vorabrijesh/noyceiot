...
ATTACK_NAME=(AutoProjectedGradientDescent CarliniWagner FastGradientMethod Deepfool UniversalPerturbation BasicIterativeMethod ElasticNet Wasserstein AdversarialPatch ShadowAttack NewtonFool TargetedUniversalPerturbation CarliniWagner)
