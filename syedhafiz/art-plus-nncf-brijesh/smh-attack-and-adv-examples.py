...
from art.attacks.evasion import DeepFool, FastGradientMethod, AutoProjectedGradientDescent, ShadowAttack, Wasserstein, ShapeShifter, UniversalPerturbation, NewtonFool #,BrendelBethgeAttack
...
process_results(predictions, y_test)
print("Completed smh-attack-and-adv-examples.py script ")
K.clear_session()
# f.close()
