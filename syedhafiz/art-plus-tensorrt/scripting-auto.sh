...
ATTACK_NAME=(CarliniWagner Deepfool FastGradientMethod ElasticNet Wasserstein UniversalPerturbation BasicIterativeMethod AdversarialPatch AutoProjectedGradientDescent ShadowAttack)
