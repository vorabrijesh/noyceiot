 ...
 * @throws IOException 
 */
	public static double accuracy(Instances test, Classifier c,String filename ) throws IOException{
		FileWriter fileWriter = new FileWriter("/home/hanwang/Downloads/"+filename);
		...
		for(int i=0;i<size;i++)
		{
			...
			try{
				...
				if(trueClass==predictedClass) {
					a++;
					//System.out.print(trueClass+' '+predictedClass+'\n');
				}
				fileWriter.write("True = "+trueClass+" Predicted = "+predictedClass+"\n");
			}catch(Exception e){
		...
		fileWriter.write("Correst Classified:"+a+" \nTotal Size "+ size+"\n");
		fileWriter.close();
		return a/size;
	}	
...
//					System.out.println("\t : "+mean[i].accuracy);
                                ...
                                mean[i].accuracy=accuracy(test,sc[i],"test.txt");
//					System.out.println("\t : "+mean[i].accuracy);
                        }
                }
 		return mean;
