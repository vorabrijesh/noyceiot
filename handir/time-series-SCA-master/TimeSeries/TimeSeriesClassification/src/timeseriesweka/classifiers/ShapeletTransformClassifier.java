...
//    n > 2000 ? 2000 : n;   
    ...
    public static void main(String[] args) throws Exception {
        String dataLocation = "/home/hanwang/Downloads";
        //String dataLocation = "..\\..\\resampled transforms\\BalancedClassShapeletTransform\\";
        String saveLocation = "/home/hanwang/Downloads/";
        String datasetName = "instancemodeldata";//"ECGFiveDays";
        int fold = 0;
        
        Instances train= ClassifierTools.loadData("/home/hanwang/Downloads/60samplestrain-1.arff");
        Instances test= ClassifierTools.loadData("/home/hanwang/Downloads/60samplestest.arff");
        ...
        System.out.print("test");
        double accuracy = utilities.ClassifierTools.accuracy(test, st,"shaplet4.txt");
