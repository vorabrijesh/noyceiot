...
//        System.out.println("trainSize ="+trainSize+" stored ="+storeCount+" recovered "+recoverCount);
    ...
    public static void main(String[] args){
            ...
            String path="/home/hwang31/dev/";

            Instances test=ClassifierTools.loadData(path+"instancemodeldata/instancemodeldata_TEST.arff");
            Instances train=ClassifierTools.loadData(path+"instancemodeldata/instancemodeldata_TRAIN.arff");
            train.setClassIndex(train.numAttributes()-1);
            c.buildClassifier(train);
            System.out.println(ClassifierTools.accuracy(test, c));
