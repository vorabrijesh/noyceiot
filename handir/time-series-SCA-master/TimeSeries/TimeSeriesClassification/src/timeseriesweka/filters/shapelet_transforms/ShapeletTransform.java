...
public class ShapeletTransform extends SimpleBatchFilter implements SaveParameterInfo, Serializable{
    ...
    public static void main(String[] args){
        try {
            final String resampleLocation = "/home/hwang31/dev/";
            final String dataset = "instancemodeldata";
            final int fold = 1;
            final String filePath = resampleLocation + File.separator + dataset + File.separator + dataset;
            Instances test, train;
            test = utilities.ClassifierTools.loadData(filePath + "_TEST.arff");
            train = utilities.ClassifierTools.loadData(filePath + "_TRAIN.arff");
            ...
            double accuracy = ClassifierTools.accuracy(tranTest, rot1,"test.txt");
            ...
            double accuracy1 = ClassifierTools.accuracy(tranTest1, rot2,"test.txt");
